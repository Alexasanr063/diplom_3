...
class BurgerOrderAPI:
    ...
    @allure.step("API: Создать новый заказ")
    ...
    @allure.step("API: Получить заказы пользователя")
    ...
    @allure.step("API: Получить детали заказа по номеру")
    ...
    @allure.step("API: Получить ленту всех заказов")
    ...
    @allure.step("API: Создать тестовый заказ")
