...
class OrdersFeedPage(BurgerBasePage):
    ...
    def wait_for_feed_page_loaded(self):
        ...
        self.wait_visibility_of_element(self.locators.ORDER_FEED_TITLE)
        self.wait_visibility_of_element(self.locators.ORDER_ITEMS_LIST)

    @allure.step("Открытие ленты заказов")
    def open_orders_feed(self):
        """Открыть раздел ленты заказов"""
        self.click_on_element(self.locators.ORDERS_FEED_TAB)
    ...
    def click_first_order(self):
        ...
        self.click_on_element(self.locators.FIRST_ORDER_ITEM)
    ...
    def wait_for_modal_opened(self):
        ...
        self.wait_visibility_of_element(self.locators.ORDER_DETAILS_MODAL)
    ...
    def is_order_info_displayed(self):
        ...
        return self.visibility_of_element(self.locators.ORDER_DETAILS_MODAL)
    ...
    def is_my_order_visible(self):
        ...
        return self.visibility_of_element(self.locators.FIRST_ORDER_ITEM)

    @allure.step("Получение количества заказов за все время")
    def get_total_orders_count(self):
        """Получить количество выполненных заказов за все время"""
        return self.text_of_element(self.locators.ORDERS_TOTAL)

    @allure.step("Получение количества заказов за сегодня")
    def get_today_orders_count(self):
        """Получить количество выполненных заказов за сегодня"""
        return self.text_of_element(self.locators.ORDERS_TODAY)

    @allure.step("Закрытие модального окна")
    def close_order_modal(self):
        """Закрыть модальное окно с деталями заказа"""
        try:
            self.click_on_element(self.locators.MODAL_CLOSE_BUTTON)
            self.wait_order_modal_window_closed(self.locators.ORDER_DETAILS_MODAL)
        except Exception:
            self.press_escape()
    ...
    def get_order_in_progress_number(self):
        ...
        if self.visibility_of_element(self.locators.ORDERS_IN_PROGRESS):
            return self.text_of_element(self.locators.ORDERS_IN_PROGRESS)
        return None
    ...
    def wait_for_order_in_feed(self, timeout=30):
        ...
        self.wait_visibility_of_element(self.locators.ORDER_ITEMS_LIST, timeout)
    ...
    def is_feed_tab_active(self):
        ...
        element = self.find_element(self.locators.ORDERS_FEED_TAB)
