...
class BurgerConstructorPage(BurgerBasePage):
    ...
    def wait_for_constructor_loaded(self):
        ...
        self.wait_visibility_of_element(self.locators.INGREDIENTS_SECTION)
        self.wait_visibility_of_element(self.locators.CONSTRUCTOR_AREA)
    ...
    def select_ingredient_category(self, category):
        ...
        if category in category_locators:
            self.click_on_element(category_locators[category])
    ...
    def add_crater_bun_to_constructor(self):
        ...
        self.move_element(self.locators.CRATER_BUN_ITEM, self.locators.CONSTRUCTOR_AREA)
    ...
    def wait_for_ingredient_added(self):
        ...
        self.wait_visibility_of_element(self.locators.INGREDIENT_COUNTER, timeout=5)

    @allure.step("Оформление заказа")
    def place_order(self):
        """Оформить заказ"""
        self.click_on_element(self.locators.PLACE_ORDER_BUTTON)
    ...
    def get_order_number(self):
        ...
        return self.text_of_element(self.locators.ORDER_NUMBER)
    ...
    def is_order_button_visible(self):
        ...
        return self.visibility_of_element(self.locators.PLACE_ORDER_BUTTON)
    ...
    def get_order_total(self):
        ...
        return self.text_of_element(self.locators.ORDER_TOTAL)
